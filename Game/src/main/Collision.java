...
//Hitbox Rand xY
        ...
        for(int i = 1; i < 5; i++) {
            ...
            switch (i) {
                ...
                case 1 -> {
                    int ntr = (t - Entity.speed - e.speedBuff()) / GamePanel.tileSize;
                ...
                case 2 -> {
                    int nbr = (b + Entity.speed + e.speedBuff()) / GamePanel.tileSize;
                ...
                case 3 -> {
                    int nlc = (l - Entity.speed - e.speedBuff()) / GamePanel.tileSize;
                ...
                case 4 -> {
                    int nrc = (r + Entity.speed+ e.speedBuff()) / GamePanel.tileSize;
    ...
    public InteractiveTile checkIT(Entity e, boolean p){
        ...
        for(InteractiveTile i :gp.interactiveTileManager.its){
            if(i != null){
                ...
                switch (e.direction) {
                    case "up" -> {
                        e.hitBox.y -= Entity.speed - e.speedBuff();
                    ...
                    case "right" -> {
                        e.hitBox.x += Entity.speed + e.speedBuff();
                        if (e.hitBox.intersects(i.hitBox)) {
                            if(i.collision){
                                e.collision = true;
                            }
